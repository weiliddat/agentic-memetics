...
description: Comprehensive security and correctness audit of a branch's changes, covering bugs, breaking changes, security issues, devex regressions, and feature-gate leaks. Use only when the user explicitly asks for thermo-nuclear-review or a thermo nuclear / thermonuclear review, or when a thermos or deep-thermos orchestration assigns this rubric. Do not invoke it as a follow-up to unrelated work.
---
