...
- Prefer plain, common words. When a simpler word carries the same meaning, use it ("use" over "leverage", "match" over "align with", "unclear" over "ambiguity around"). Keep established technical and domain terms where they are the precise name for the thing; never trade correctness for simplicity.
